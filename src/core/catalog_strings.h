...
#define MSG_CLI_REKEY_LOWER_PROMPT_STR "Re-key LOWER for quicker unlocks here? This REDUCES security. [y/N]"
...
static const char AmiAuth_Block[] =
{
    ...
    MSG_CLI_REKEY_SLOW_NOTICE_STR "\x00"
     "\x00\x00\x00\x1f" "\x00\x44"
    MSG_CLI_REKEY_LOWER_PROMPT_STR "\x00"
